...
class SpinnerReimbursementAdapter(context: Context, list: List<DataXXXXXXXXXXXXXXXXXXXXXXXXXXX>) :
    ArrayAdapter<DataXXXXXXXXXXXXXXXXXXXXXXXXXXX>(context, 0, list) {
